      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-primary to-primary-dark text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl opacity-90 max-w-2xl mx-auto">
            Stories, insights, and resources about hyperhidrosis and climate health justice
          </p>
        </div>
      </section>
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  We're working on bringing you inspiring stories, helpful resources, and the latest updates 
                  on hyperhidrosis awareness and climate-health advocacy.
                </p>
                <p className="text-muted-foreground">
                  Check back soon or subscribe to our newsletter to be notified when we launch.
                </p>
              </CardContent>
            </Card>
          </div>
