      ...
      <nav className="nav" role="navigation" aria-label="Main navigation">
        <div className="nav-inner">
          ...
          <div className="nav-links">
            ...
            <a href="https://docs.google.com/forms/d/1VHmpQSef9rYXU4QnU0Z0YsUR4YEjPR2eYr0ksvFwpdU/edit" target="_blank" rel="noopener noreferrer" className="nav-cta">Take the Survey</a>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="mobile-menu">
            {[
              ...
              { href: "https://docs.google.com/forms/d/1VHmpQSef9rYXU4QnU0Z0YsUR4YEjPR2eYr0ksvFwpdU/edit", label: "Take the Survey →", target: "_blank" },
            ].map(link => (
        ...
        <div className="hero">
          <div className="hero-text">
            ...
            <div className="hero-btns">
              <a href="https://docs.google.com/forms/d/1VHmpQSef9rYXU4QnU0Z0YsUR4YEjPR2eYr0ksvFwpdU/edit" target="_blank" rel="noopener noreferrer" className="btn-primary">
